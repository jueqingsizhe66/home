...
# create the Widget and then initialize the widget!
        thousandsLabel = QLabel("&Thousands separator")
        self.thousandsEdit = QLineEdit(format["thousandsseparator"])
        thousandsLabel.setBuddy(self.thousandsEdit)
        decimalMarkerLabel = QLabel("<font color=red size =14>Decimal &marker</font>")
...
#Show the bad person and the bad things which bad people will do!
        try:
            if len(decimal) == 0:
